...
.error-page-main:before{content:'';display:block;background:url(/demo/img/errorPageBorder.png);height:7px;position:absolute;top:-7px;width:100%;left:0}
        ...
        <div class="error-page-main">
            ...
            <div class="error-page-actions">
                ...
                <div>
                    <h4>可以尝试：</h4>
                    <ul>
                        <li><a href="http:127.0.0.1:8080/demo">返回首页</a></li>
                    </ul>
                </div>
            </div>
        </div>
